...
In the `boards/dongle` directory, you'll find some `*.hex` files. These are pre-compiled Rust programs that have been converted into the Intel Hex format that the `nrfutil` tool expects.
